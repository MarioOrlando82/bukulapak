<div aria-live="polite" aria-atomic="true" class="position-relative border-0">
    <div class="toast-container position-absolute top-0 end-0 p-3">
        <div class="toast {{ $type === 'success' ? 'text-white' : 'bg-danger text-white' }}" role="alert" aria-live="assertive" aria-atomic="true" data-bs-autohide="true" data-bs-delay="10000"
