    ...
    <div class="d-flex overflow-hidden position-relative" style="height: 100vh">
        ...
        <div class="d-flex align-items-center justify-content-center z-1 left-section">
            <div class="col-sm-12 col-md-8 col-lg-8 mt-5">
                <div class="mb-4 ms-2">
                    <p class="text-black fw-bold mb-2 fs-2">@lang('auth.lbl_loginTitle')<span class="text-warning">.</span></p>
                    <p class="text-black text-decoration-none fw-semibold">
                        @lang('auth.lbl_register')<a class="text-warning fw-bold link"
                            href="{{ route('register') }}">@lang('auth.link_register')</a>
                    </p>
                </div>
                <div>
                    <form id="loginForm" method="POST" action="{{ url('/login') }}">
                        ...
                        <div class="form-floating mb-3">
                            ...
                            <div class="invalid-feedback">@lang('auth.lbl_passwordReq')</div>
                        </div>
                        <button type="submit" class="btn btn-warning w-100 text-white my-3 fw-semibold"
                            style="border-radius: 15px">@lang('auth.btn_login')</button>
                    </form>
                </div>
            </div>
        </div>
